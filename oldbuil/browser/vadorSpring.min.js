...
function isIndex(r,e){return r="number"==typeof r||reIsUint.test(r)?+r:-1,e=null==e?MAX_SAFE_INTEGER:e,r>-1&&r%1==0&&e>r}function isKey(r,e){var t=typeof r;if("string"==t&&reIsPlainProp.test(r)||"number"==t)return!0;if(isArray(r))return!1;var n=!reIsDeepProp.test(r);return n||null!=e&&r in toObject(e)}function toObject(r){return isObject(r)?r:Object(r)}function isObject(r){var e=typeof r;return!!r&&("object"==e||"function"==e)}function set(r,e,t){if(null==r)return r;var n=e+"";e=null!=r[n]||isKey(e,r)?[n]:toPath(e);for(var i=-1,s=e.length,u=s-1,o=r;null!=o&&++i<s;){var a=e[i];isObject(o)&&(i==u?o[a]=t:null==o[a]&&(o[a]=isIndex(e[i+1])?[]:{})),o=o[a]}return r}var toPath=require("lodash._topath"),isArray=require("lodash.isarray"),reIsDeepProp=/\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\n\\]|\\.)*?\1)\]/,reIsPlainProp=/^\w*$/,reIsUint=/^\d+$/,MAX_SAFE_INTEGER=9007199254740991;module.exports=set;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,s,r){return s&&e(t.prototype,s),r&&e(t,r),t}}(),_http=require("./http"),_restResource=require("./restResource"),_lodashObjectAssign=require("lodash/object/assign"),_lodashObjectAssign2=_interopRequireDefault(_lodashObjectAssign),RestClient=function(){function e(t){var s=void 0===arguments[1]?{}:arguments[1];_classCallCheck(this,e),this._baseUrl=t,this._config=s,this._interceptors=s.interceptors||[],this._headers=s.headers||{},this._http=s.http||null,this._cache={}}return _createClass(e,[{key:"baseUrl",set:function(e){this._baseUrl=e}},{key:"addHeader",value:function(e,t){this._headers[e]=t}},{key:"http",set:function(e){this._http=e}},{key:"addInterceptor",value:function(e){var t=void 0===arguments[1]?!0:arguments[1];t?this._interceptors.push(e):this._interceptors.unshift(e)}},{key:"resource",value:function(e){var t=void 0===arguments[1]?{}:arguments[1];if(!this._cache[e]){var s=_lodashObjectAssign2["default"]({},this._config,t);s.defaultHeaders=_lodashObjectAssign2["default"]({},this._headers,t.defaultHeaders||{}),s.interceptors=(t.interceptors||[]).concat(this._interceptors),s.http||(s.http=this._http),this._cache[e]=new _restResource.RestResource(this._baseUrl,e,s)}return this._cache[e]}}]),e}();exports.RestClient=RestClient;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_vador=require("vador"),_lodashHas=require("lodash.has"),_lodashHas2=_interopRequireDefault(_lodashHas),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),debug=new _debug2["default"]("halClient [Interceptor]"),PopulateInterceptor=function(e){function r(){_classCallCheck(this,r),null!=e&&e.apply(this,arguments)}return _inherits(r,e),_createClass(r,[{key:"response",value:function(e){var r=this;debug("populate interceptor begin");var t=e.value,n=e.request;if(!e.hasValue()||!n.hasPopulate())return debug("Populate extractor end (do nothing)"),e;var o=[];return Array.isArray(t)?t.forEach(function(e){o.push(r._populateOne(e,n))}):o.push(this._populateOne(t,n)),Promise.all(o).then(function(){return debug("populate interceptor end"),e})}},{key:"_populateOne",value:function(e,r){debug("populate one");var t=e["**links**"],n=[],o=r.populates;return o.keys().forEach(function(u){if(u&&_lodashHas2["default"](t,u)){var a=t[u],l=a.substring(0,a.indexOf(u)),s=r.restResource._createSubInstance(l,u),i=s.findAll(),p=o.getSubPopulate(u);Array.isArray(p)&&p.length&&i.populate.apply(i,_toConsumableArray(p)),i=i.sendRequest().then(function(r){e[u]=r.value}),n.push(i)}}),Promise.all(n).then(function(){return e})}},{key:"responseError",value:function(e){console.error("populate extractor responseError",e)}}]),r}(_vador.ResponseInterceptor);exports.PopulateInterceptor=PopulateInterceptor;
},{"debug":6,"lodash.has":20,"vador":38}],84:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var a=0;a<t.length;a++){var u=t[a];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,a,u){return a&&e(t.prototype,a),u&&e(t,u),t}}(),_lodashSet=require("lodash.set"),_lodashSet2=_interopRequireDefault(_lodashSet),_lodashIsobject=require("lodash.isobject"),_lodashIsobject2=_interopRequireDefault(_lodashIsobject),Populate=function(){function e(){var t=this,a=void 0===arguments[0]?[]:arguments[0];_classCallCheck(this,e),Array.isArray(a)||(a=[]),this._populates={},a.forEach(function(e){t._populates=_lodashSet2["default"](t._populates,e,{})})}return _createClass(e,[{key:"keys",value:function(){return Object.keys(this._populates)}},{key:"populates",get:function(){return this._populates}},{key:"getPopulateArray",value:function(){return this._getPopulate(this._populates)}},{key:"_getPopulate",value:function(e){var t=this,a=[];return Object.keys(e).forEach(function(u){var o=e[u];if(_lodashIsobject2["default"](o)&&Object.keys(o).length){var r=t._getPopulate(o);r.forEach(function(e){return a.push(u+"."+e)})}else a.push(u)}),a}},{key:"getSubPopulate",value:function(e){var t=this._populates[e];return t?this._getPopulate(t):[]}}]),e}();exports.Populate=Populate;
