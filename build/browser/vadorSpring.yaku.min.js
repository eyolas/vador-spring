...
"use strict";exports.extract=function(e){return e.split("?")[1]||""},exports.parse=function(e){return"string"!=typeof e?{}:(e=e.trim().replace(/^(\?|#|&)/,""),e?e.split("&").reduce(function(e,n){var r=n.replace(/\+/g," ").split("="),t=r[0],o=r[1];return t=decodeURIComponent(t),o=void 0===o?null:decodeURIComponent(o),e.hasOwnProperty(t)?Array.isArray(e[t])?e[t].push(o):e[t]=[e[t],o]:e[t]=o,e},{}):{})},exports.stringify=function(e){return e?Object.keys(e).sort().map(function(n){var r=e[n];return Array.isArray(r)?r.sort().map(function(e){return encodeURIComponent(n)+"="+encodeURIComponent(e)}).join("&"):encodeURIComponent(n)+"="+encodeURIComponent(r)}).join("&"):""};

},{}],46:[function(require,module,exports){
"use strict";var isObj=require("is-obj");module.exports=function(e,r){if(!isObj(e))throw new TypeError("Expected an object");r=r||{},"function"==typeof r&&(r={compare:r});var t=r.deep,o=function(e){for(var n={},i=Object.keys(e).sort(r.compare),c=0;c<i.length;c++){var s=i[c],u=e[s];n[s]=t&&u!==e&&isObj(u)?o(u):u}return n};return o(e)};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,s,r){return s&&e(t.prototype,s),r&&e(t,r),t}}(),_http=require("./http"),_restResource=require("./restResource"),_lodashObjectAssign=require("lodash/object/assign"),_lodashObjectAssign2=_interopRequireDefault(_lodashObjectAssign),RestClient=function(){function e(t){var s=void 0===arguments[1]?{}:arguments[1];_classCallCheck(this,e),this._baseUrl=t,this._config=s,this._interceptors=s.interceptors||[],this._headers=s.headers||{},this._http=s.http||null,this._cache={}}return _createClass(e,[{key:"addHeader",value:function(e,t){this._headers[e]=t}},{key:"addInterceptor",value:function(e){var t=void 0===arguments[1]?!0:arguments[1];t?this._interceptors.push(e):this._interceptors.unshift(e)}},{key:"instanciateResource",value:function(e,t){return new _restResource.RestResource(this._baseUrl,e,t)}},{key:"resource",value:function(e){var t=void 0===arguments[1]?{}:arguments[1];if(!this._cache[e]){var s=_lodashObjectAssign2["default"]({},this._config);s.http=t.http||null,s.defaultHeaders=_lodashObjectAssign2["default"]({},this._headers,t.defaultHeaders||{}),s.interceptors=(t.interceptors||[]).concat(this._interceptors),s.http||(s.http=this._http),this._cache[e]=this.instanciateResource(e,s)}return this._cache[e]}},{key:"baseUrl",set:function(e){this._baseUrl=e}},{key:"http",set:function(e){this._http=e}}]),e}();exports.RestClient=RestClient;

},{"./http":53,"./restResource":58,"lodash/object/assign":36}],58:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_request=require("./request"),_http=require("./http"),_lodashLangIsObject=require("lodash/lang/isObject"),_lodashLangIsObject2=_interopRequireDefault(_lodashLangIsObject),_uriTemplate=require("uri-template"),RestResource=function(){function e(t,r){var s=this,n=void 0===arguments[2]?{}:arguments[2];_classCallCheck(this,e),this._baseUrl=t+"/",this.resourceName=r,this._config=n,this._config.defaultHeaders=n.defaultHeaders||{},this._config.interceptors=n.interceptors||[],this._config.http=n.http||new _http.Http;var n=this._config[r]||{};_lodashLangIsObject2["default"](n.methods)&&!function(){var e=n.methods;Object.keys(e).forEach(function(t){var r=Array,n=e[t];if(_lodashLangIsObject2["default"](e[t])){var u=e[t];r=u.type,n=u.href}var a=_uriTemplate.parse(n);s[t]=function(e,t){return function(){var r=void 0===arguments[0]?{}:arguments[0],n=e.expand(r);return s.constructBaseRequest("get",t,n)}}(a,r)})}()}return _createClass(e,[{key:"constructBaseRequest",value:function(){var e=void 0===arguments[0]?"get":arguments[0],t=void 0===arguments[1]?Array:arguments[1],r=void 0===arguments[2]?"":arguments[2],s=new _request.Request(this._baseUrl,this.resourceName,this,this._config);return s.responseType=t,s.url=this._baseUrl+this.resourceName+r,s.method=e,s}},{key:"findAll",value:function(){return this.constructBaseRequest()}},{key:"findOne",value:function(e){return this.constructBaseRequest("get",Object,"/"+e)}},{key:"save",value:function(e){var t=void 0;return t=e.hasOwnProperty("id")?this.merge(e):this.create(e),t.sendRequest()}},{key:"create",value:function(e){return this.constructBaseRequest("post",Object).send(e)}},{key:"merge",value:function(e){return this.constructBaseRequest("put",Object,"/"+e.id).send(e)}},{key:"_createSubInstance",value:function(t,r,s){return new e(t,r,s)}}]),e}();exports.RestResource=RestResource;
...
var superagent=module.exports=require("superagent");superagent.Promise=Promise;var Request=superagent.Request,SuperagentPromiseError=superagent.SuperagentPromiseError=function(e){this.name="SuperagentPromiseError",this.message=e||"Bad request"};SuperagentPromiseError.prototype=new Error,SuperagentPromiseError.prototype.constructor=SuperagentPromiseError,Request.prototype.promise=function(){var e,r=this;return new superagent.Promise(function(t,o){r.end(function(r,s){r?(e=new SuperagentPromiseError(r),s&&(e.status=s.status,e.body=s.body,e.res=s),o(e)):t(s)})})},Request.prototype.then=function(){var e=this.promise();return e.then.apply(e,arguments)};
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var o=r[t];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(r,t,o){return t&&e(r.prototype,t),o&&e(r,o),r}}(),_get=function(e,r,t){for(var o=!0;o;){var n=e,u=r,a=t;l=s=i=void 0,o=!1,null===n&&(n=Function.prototype);var l=Object.getOwnPropertyDescriptor(n,u);if(void 0!==l){if("value"in l)return l.value;var i=l.get;return void 0===i?void 0:i.call(a)}var s=Object.getPrototypeOf(n);if(null===s)return void 0;e=s,r=u,t=a,o=!0}},_vador=require("vador"),_lodashObjectHas=require("lodash/object/has"),_lodashObjectHas2=_interopRequireDefault(_lodashObjectHas),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),debug=new _debug2["default"]("halClient [Interceptor]"),PopulateInterceptor=function(e){function r(){_classCallCheck(this,r),_get(Object.getPrototypeOf(r.prototype),"constructor",this).apply(this,arguments)}return _inherits(r,e),_createClass(r,[{key:"response",value:function(e){var r=this;debug("populate interceptor begin");var t=e.value,o=e.request;if(!e.hasValue()||!o.hasPopulate())return debug("Populate extractor end (do nothing)"),e;var n=[];return Array.isArray(t)?t.forEach(function(e){n.push(r._populateOne(e,o))}):n.push(this._populateOne(t,o)),Promise.all(n).then(function(){return debug("populate interceptor end"),e})}},{key:"_populateOne",value:function(e,r){debug("populate one");var t=e["**links**"],o=[],n=r.populates;return n.keys().forEach(function(u){if(u&&_lodashObjectHas2["default"](t,u)){var a=t[u],l=a.substring(0,a.indexOf(u)),i=r.restResource._createSubInstance(l,u),s=i.findAll(),p=n.getSubPopulate(u);Array.isArray(p)&&p.length&&s.populate.apply(s,_toConsumableArray(p)),s=s.sendRequest().then(function(r){e[u]=r.value}),o.push(s)}}),Promise.all(o).then(function(){return e})}},{key:"responseError",value:function(e){console.error("populate extractor responseError",e)}}]),r}(_vador.ResponseInterceptor);exports.PopulateInterceptor=PopulateInterceptor;
