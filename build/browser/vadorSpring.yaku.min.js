...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function isNotEmpty(e){return e&&Array.isArray(e)&&e.length}function normalizeUrl(e){return IS_ABSOLUTE.test(e)?_normalizeUrl2["default"](e):_normalizeUrl2["default"](e).replace("http://","")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.isNotEmpty=isNotEmpty,exports.normalizeUrl=normalizeUrl;var _normalizeUrl=require("normalize-url"),_normalizeUrl2=_interopRequireDefault(_normalizeUrl),IS_ABSOLUTE=/^http.*/;
