...
function isArguments(r){return isObjectLike(r)&&isArrayLike(r)&&objToString.call(r)==argsTag}var isArrayLike=require("../internal/isArrayLike"),isObjectLike=require("../internal/isObjectLike"),argsTag="[object Arguments]",objectProto=Object.prototype,objToString=objectProto.toString;module.exports=isArguments;
...
"use strict";function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var n=0;n<r.length;n++){var t=r[n];t.enumerable=t.enumerable||!1,t.configurable=!0,"value"in t&&(t.writable=!0),Object.defineProperty(e,t.key,t)}}return function(r,n,t){return n&&e(r.prototype,n),t&&e(r,t),r}}(),_utils=require("./utils"),Config=function(){function e(){_classCallCheck(this,e),this._promise=Promise}return _createClass(e,[{key:"Promise",set:function(e){if(!_utils.isPromise(e))throw new Error("Promise must be a promise");this._promise=e},get:function(){return this._promise}}]),e}(),config=new Config;exports.config=config;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function isNotEmpty(e){return e&&Array.isArray(e)&&e.length}function normalizeUrl(e){return IS_ABSOLUTE.test(e)?_normalizeUrl2["default"](e):_normalizeUrl2["default"](e).replace("http://","")}function isPromise(e){return"function"==typeof e.resolve}Object.defineProperty(exports,"__esModule",{value:!0}),exports.isNotEmpty=isNotEmpty,exports.normalizeUrl=normalizeUrl,exports.isPromise=isPromise;var _normalizeUrl=require("normalize-url"),_normalizeUrl2=_interopRequireDefault(_normalizeUrl),IS_ABSOLUTE=/^http.*/;
...
(function (__filename){
!function(n){var t;return t=function(){function t(n){var t;w&&(this[i]=y()),n!==o&&(t=m(n)(d(this,f),d(this,c)),t===s&&E(this,c,t.e))}var e,r,o,u,i,c,f,a,l,s,p,_,v,h,d,y,m,g,j,k,w,R,T,b,x,C,E,F,S,U;t.prototype.then=function(n,t){return p(this,T(),n,t)},t.prototype["catch"]=function(n){return this.then(void 0,n)},t.resolve=function(n){return n instanceof t?n:F(T(),n)},t.reject=function(n){return E(T(),c,n)},t.race=function(n){var e,r,o;if(_(n),r=n.length,0===r)return t.resolve([]);for(o=T(),e=0;r>e&&(F(o,n[e++]),o._state===u););return o},t.all=function(n){var e,r,o,u,i,a,l,s;if(_(n),e=t.resolve,i=r=n.length,0===i)return e([]);for(l=T(),s=[],o=0,a=function(n){E(l,c,n)},u=function(t){e(n[t]).then(function(n){s[t]=n,--r||E(l,f,s)},a)};i>o;)u(o++);return l},t.onUnhandledRejection=function(n,t){var e,r;if(R(console)){if(e=[n&&n.stack?n.stack.trim():n],w&&t[i])for(t[a]&&e.push(t[a].trim());t;)e.push(t[i].trim()),t=t._pre;return r=e.join("\n"),"string"==typeof __filename&&(r=r.replace(RegExp(".+"+__filename+".+\\n?","g"),"")),console.error("Unhandled Rejection:",r),e}},w=!1,t.enableLongStackTrace=function(){w=!0},l=null,s={e:null},o={},R=function(n){return"object"==typeof n},k=function(n){return"function"==typeof n},b=function(n,t){n[t]=void 0},U=function(){var n;try{return l.apply(this,arguments)}catch(t){return n=t,s.e=n,s}},m=function(n){return l=n,U},h=function(t,e){var r,o,u,i;return o=Array(t),u=0,r=function(){var n,r,i,c,f;for(n=0;u>n;)i=n++,f=n++,r=o[i],c=o[f],b(o,i),b(o,f),e(r,c);u=0,o.length=t},i=function(){var t,e,o,u,i,c;e=n.document;try{return u=n.process.nextTick,function(){u(r)}}catch(f){}return(u=n.setImmediate)?function(){u(r)}:(o=n.MutationObserver)?(t=1,i=e.createTextNode(""),c=new o(r),c.observe(i,{characterData:!0}),function(){i.data=t=-t}):function(){setTimeout(r)}}(),function(n,t){o[u++]=n,o[u++]=t,2===u&&i()}},_=function(n){if(!(n instanceof Array))throw g(r)},g=function(n){return new TypeError(n)},y=function(n){return(new Error).stack.replace("Error",n?"":"From previous event:")},c=0,f=1,u=2,i="_pStack",a="_sStack",e="promise_circular_chain",r="invalid_argument",t.prototype._state=u,t.prototype._pCount=0,t.prototype._pre=null,T=function(){return new t(o)},d=function(n,t){return function(e){return w&&(n[a]=y(!0)),E(n,t,e)}},p=function(n,t,e,r){return k(e)&&(t._onFulfilled=e),k(r)&&(t._onRejected=r),t._pre=n,n._state===u?n[n._pCount++]=t:x(n,t),t},x=h(1e3,function(n,t){var e,r;return e=n._state?t._onFulfilled:t._onRejected,void 0===e?void E(t,n._state,n._value):(r=m(v)(e,n._value),r===s?void E(t,c,r.e):void F(t,r))}),C=h(100,function(n){var e;e=function(n){var t,r;if(t=0,r=n._pCount,!n._onRejected){for(;r>t;)if(!e(n[t++]))return;return!0}},e(n)&&t.onUnhandledRejection(n._value,n)}),v=function(n,t){return n(t)},E=function(n,t,e){var r,o;if(n._state===u){for(n._state=t,n._value=e,t!==c||n._pre&&n._pre._state!==f||C(n),r=0,o=n._pCount;o>r;)x(n,n[r++]);return n}},F=function(n,r){var o;if(r===n&&r)return void E(n,c,g(e));if(null!==r&&(k(r)||R(r))){if(o=m(j)(r),o===s)return void E(n,c,o.e);k(o)?(r instanceof t&&(r._pre=n._pre,n._pre=r),S(n,r,o)):E(n,f,r)}else E(n,f,r);return n},j=function(n){return n.then},S=function(n,t,e){var r;r=m(e).call(t,function(e){t&&(t=null,F(n,e))},function(e){t&&(t=null,E(n,c,e))}),r===s&&t&&(E(n,c,r.e),t=null)};try{module.exports=t}catch(A){try{define(function(){return t})}catch(A){n.Yaku=t}}return t}()}(this||window);
