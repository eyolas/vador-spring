...
},{"./utils":42,"normalize-url":27}],39:[function(require,module,exports){
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_request2=require("./request"),_response=require("./response"),_http=require("./http"),_utils=require("./utils"),_coreBaseInterceptors=require("../core/baseInterceptors/"),RestResource=function(){function e(t,r){var s=void 0===arguments[2]?{}:arguments[2];_classCallCheck(this,e),this._baseUrl=t+"/",this._defaultHeaders=s.defaultHeaders||[],this._interceptors=s.interceptors||[],this._http=s.http||new _http.Http,this._resourceName=r,this._request=new _request2.Request(r,this),this._allConfig=s,this._config=s[r]||{},this._restKeys=["findAll","search","findOne","save","toJSON"]}return _createClass(e,[{key:"constructBaseRequest",value:function(){var e=void 0===arguments[0]?"get":arguments[0],t=void 0===arguments[1]?Array:arguments[1],r=void 0===arguments[2]?"":arguments[2];return this._request.reset(),this._request.responseType=t,this._request.url=this._baseUrl+this._resourceName+r,this._request.method=e,this._request.headers=this._defaultHeaders,this}},{key:"interceptors",set:function(e){this._interceptors=e}},{key:"config",set:function(e){this._config=e}},{key:"query",value:function(e){return this._request.query(e),this}},{key:"set",value:function(e,t){return this._request.set(e,t),this}},{key:"send",value:function(e){return this._request.send(e),this}},{key:"findAll",value:function(){return this.constructBaseRequest()}},{key:"search",value:function(){var e=void 0===arguments[0]?{}:arguments[0];return this.findAll().query(e)}},{key:"findOne",value:function(e){return this.constructBaseRequest("get",Object,"/"+e)}},{key:"save",value:function(e){var t=void 0;return t=e.hasOwnProperty("id")?this.merge(e):this.create(e),t.sendRequest()}},{key:"create",value:function(e){return this.constructBaseRequest("post",Object).send(e)}},{key:"merge",value:function(e){return this.constructBaseRequest("put",Object,"/"+e.id).send(e)}},{key:"_createSubInstance",value:function(t,r){return new e(t,r,this._allConfig)}},{key:"_proxifyOne",value:function(e){var t=this,r=function(e){if(!e)return e;var r={};return Object.keys(e).forEach(function(s){~t._restKeys.indexOf(s)||(r[s]=e[s])}),r},s=r(e);return Object.defineProperty(s,"**oldState**",{value:r(e)}),["findAll","search","findOne"].forEach(function(e){s[e]=function(r){for(var n=arguments.length,u=Array(n>1?n-1:0),i=1;n>i;i++)u[i-1]=arguments[i];var o=t._baseUrl+t._resourceName+"/"+s.id+"/",a=t._createSubInstance(o,r);return a[e].apply(a,u).sendRequest()}}),s.save=function(){return t.save(s.toJSON())},s.toJSON=function(){return r(this)},s}},{key:"proxify",value:function(e){var t=this,r=e.value;e.request;if(!Array.isArray(r))return this._proxifyOne(r);var s=function(){var e=[];return r.forEach(function(r){return e.push(t._proxifyOne(r))}),{v:e}}();return"object"==typeof s?s.v:void 0}},{key:"sendRequest",value:function(){var e=this,t=void 0===arguments[0]?!0:arguments[0],r=function(t){return e._http.request(t).then(function(e){var r=e.body;if(!r&&e.text)try{r=JSON.parse(e.text)}catch(s){r=null}return new _response.Response(r,e,t)})},s=[r,void 0];_utils.isNotEmpty(this._interceptors)&&this._interceptors.forEach(function(e){e instanceof _coreBaseInterceptors.RequestInterceptor&&s.unshift(e.request.bind(e),e.requestError.bind(e)),e instanceof _coreBaseInterceptors.ResponseInterceptor&&s.push(e.response.bind(e),e.responseError.bind(e))});for(var n=Promise.resolve(this._request);s.length;){var u=s.shift(),i=s.shift();n=n.then(u,i)}return n=n.then(function(r){return t&&(r.value=e.proxify(r)),r})}}]),e}();exports.RestResource=RestResource;
},{"../core/baseInterceptors/":32,"./http":36,"./request":38,"./response":39,"./utils":42}],42:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_vador=require("vador"),_lodashHas=require("lodash.has"),_lodashHas2=_interopRequireDefault(_lodashHas),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),debug=new _debug2["default"]("halClient [Interceptor]"),CACHE_FETCH="**cache_fetch**",PopulateInterceptor=function(e){function r(){_classCallCheck(this,r),null!=e&&e.apply(this,arguments)}return _inherits(r,e),_createClass(r,[{key:"response",value:function(e){var r=this;debug("populate interceptor begin");var t=e.value,n=e.request;if(!e.hasValue())return debug("id extractor end (do nothing)"),e;var o=[];return Array.isArray(t)?t.forEach(function(e){o.push(r._populateOne(e,n))}):o.push(this._populateOne(t,n)),Promise.all(o).then(function(){return debug("populate interceptor end"),e})}},{key:"_populateOne",value:function(e,r){debug("populate one");var t=e["**links**"];e[CACHE_FETCH]=[];var n=[];return r.populates.forEach(function(o){var u=o.split("."),a=u.shift(),l=t[a];if(a&&_lodashHas2["default"](t,a)&&!~e[CACHE_FETCH].indexOf(l)){e[CACHE_FETCH].push(l);var s=l.substring(0,l.indexOf(a)),i=r.restResource._createSubInstance(s,a),p=i.findAll();u&&u.length&&p.populate(u.join(".")),p=p.sendRequest().then(function(r){e[a]=r[0]}),n.push(p)}}),Promise.all(n).then(function(){return _lodashHas2["default"](e,CACHE_FETCH)&&delete e[CACHE_FETCH],e})}},{key:"responseError",value:function(e){console.error("populate extractor responseError",e)}}]),r}(_vador.ResponseInterceptor);exports.PopulateInterceptor=PopulateInterceptor;
