...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var u=t[r];u.enumerable=u.enumerable||!1,u.configurable=!0,"value"in u&&(u.writable=!0),Object.defineProperty(e,u.key,u)}}return function(t,r,u){return r&&e(t.prototype,r),u&&e(t,u),t}}(),_utils=require("./utils"),_normalizeUrl=require("normalize-url"),_normalizeUrl2=_interopRequireDefault(_normalizeUrl),Request=function(){function e(t,r){_classCallCheck(this,e),this._url=null,this.method="get",this.responseType=Object,this.resourceName=t,this.headers={},this.query=[],this.data=[],this.restResource=r}return _createClass(e,[{key:"url",set:function(e){this._url=_normalizeUrl2["default"](e)},get:function(){return _normalizeUrl2["default"](this._url)}},{key:"reset",value:function(){this.headers=[],this.query=[],this.data=[]}},{key:"query",value:function(e){this.query.push(e)}},{key:"set",value:function(e,t){this.headers[e]=t}},{key:"send",value:function(e){this.data.push(e)}}]),e}();exports.Request=Request;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var n=t[r];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(t,r,n){return r&&e(t.prototype,r),n&&e(t,n),t}}(),_request2=require("./request"),_response=require("./response"),_http=require("./http"),_utils=require("./utils"),_coreBaseInterceptors=require("../core/baseInterceptors/"),_bluebird=require("bluebird"),_bluebird2=_interopRequireDefault(_bluebird),RestResource=function(){function e(t,r){var n=void 0===arguments[2]?{}:arguments[2];_classCallCheck(this,e),this._baseUrl=t+"/",this._defaultHeaders=n.defaultHeaders||[],this._interceptors=n.interceptors||[],this._http=n.http||new _http.Http,this._resourceName=r,this._request=new _request2.Request(r,this),this._allConfig=n,this._config=n[r]||{},this._restKeys=["findAll","search","findOne","save","toJSON"]}return _createClass(e,[{key:"constructBaseRequest",value:function(){var e=void 0===arguments[0]?"get":arguments[0],t=void 0===arguments[1]?Array:arguments[1],r=void 0===arguments[2]?"":arguments[2];return this._request.reset(),this._request.responseType=t,this._request.url=this._baseUrl+this._resourceName+r,this._request.method=e,this._request.headers=this._defaultHeaders,this}},{key:"interceptors",set:function(e){this._interceptors=e}},{key:"config",set:function(e){this._config=e}},{key:"query",value:function(e){return this._request.query(e),this}},{key:"set",value:function(e,t){return this._request.set(e,t),this}},{key:"send",value:function(e){return this._request.send(e),this}},{key:"findAll",value:function(){return this.constructBaseRequest()}},{key:"search",value:function(){var e=void 0===arguments[0]?{}:arguments[0];return this.findAll().query(e)}},{key:"findOne",value:function(e){return this.constructBaseRequest("get",Object,"/"+e)}},{key:"save",value:function(e){var t=void 0;return t=e.hasOwnProperty("id")?this.merge(e):this.create(e),t.sendRequest()}},{key:"create",value:function(e){return this.constructBaseRequest("post",Object).send(e)}},{key:"merge",value:function(e){return this.constructBaseRequest("put",Object,"/"+e.id).send(e)}},{key:"_createSubInstance",value:function(t,r){return new e(t,r,this._allConfig)}},{key:"_proxifyOne",value:function(e){var t=this,r=function(e){if(!e)return e;var r={};return Object.keys(e).forEach(function(n){~t._restKeys.indexOf(n)||(r[n]=e[n])}),r},n=r(e);return Object.defineProperty(n,"**oldState**",{value:r(e)}),["findAll","search","findOne"].forEach(function(e){n[e]=function(r){for(var s=arguments.length,u=Array(s>1?s-1:0),i=1;s>i;i++)u[i-1]=arguments[i];var o=t._baseUrl+t._resourceName+"/"+n.id+"/",a=t._createSubInstance(o,r);return a[e].apply(a,u).sendRequest()}}),n.save=function(){return t.save(n.toJSON())},n.toJSON=function(){return r(this)},n}},{key:"proxify",value:function(e){var t=this,r=e.value;e.request;if(!Array.isArray(r))return this._proxifyOne(r);var n=function(){var e=[];return r.forEach(function(r){return e.push(t._proxifyOne(r))}),{v:e}}();return"object"==typeof n?n.v:void 0}},{key:"sendRequest",value:function(){var e=this,t=void 0===arguments[0]?!0:arguments[0],r=function(t){return e._http.request(t).then(function(e){var r=e.body;if(!r&&e.text)try{r=JSON.parse(e.text)}catch(n){r=null}return new _response.Response(r,e,t)})},n=[r,void 0];_utils.isNotEmpty(this._interceptors)&&this._interceptors.forEach(function(e){e instanceof _coreBaseInterceptors.RequestInterceptor&&n.unshift(e.request.bind(e),e.requestError.bind(e)),e instanceof _coreBaseInterceptors.ResponseInterceptor&&n.push(e.response.bind(e),e.responseError.bind(e))});for(var s=_bluebird2["default"].resolve(this._request);n.length;){var u=n.shift(),i=n.shift();s=s.then(u,i)}return s=s.then(function(r){t&&(r.value=e.proxify(r));var n=[r.value,r.result];return n})}}]),e}();exports.RestResource=RestResource;
...
var Promise=require("bluebird"),superagent=module.exports=require("superagent"),Request=superagent.Request,SuperagentPromiseError=superagent.SuperagentPromiseError=function(e){this.name="SuperagentPromiseError",this.message=e||"Bad request"};SuperagentPromiseError.prototype=new Error,SuperagentPromiseError.prototype.constructor=SuperagentPromiseError,Request.prototype.promise=function(){var e,r=this;return new Promise(function(t,o){r.end(function(n,s){if("undefined"!=typeof s&&s.status>=400){var u="cannot "+r.method+" "+r.url+" ("+s.status+")";e=new SuperagentPromiseError(u),e.status=s.status,e.body=s.body,e.res=s,o(e)}else n?o(new SuperagentPromiseError(n)):t(s)})}).cancellable().caught(Promise.CancellationError,function(e){throw r.abort(),e})},Request.prototype.then=function(){var e=this.promise();return e.then.apply(e,arguments)};
...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function _inherits(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(e.__proto__=t)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var o=t[r];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(t,r,o){return r&&e(t.prototype,r),o&&e(t,o),t}}(),_get=function(e,t,r){for(var o=!0;o;){var n=e,a=t,u=r;i=s=l=void 0,o=!1;var i=Object.getOwnPropertyDescriptor(n,a);if(void 0!==i){if("value"in i)return i.value;var l=i.get;return void 0===l?void 0:l.call(u)}var s=Object.getPrototypeOf(n);if(null===s)return void 0;e=s,t=a,r=u,o=!0}},_vador=require("vador"),HalRequest=function(e){function t(e,r){_classCallCheck(this,t),_get(Object.getPrototypeOf(t.prototype),"constructor",this).call(this,e,r),this._populate=[]}return _inherits(t,e),_createClass(t,[{key:"populate",value:function(){for(var e,t=arguments.length,r=Array(t),o=0;t>o;o++)r[o]=arguments[o];(e=this._populate).push.apply(e,r)}},{key:"populates",get:function(){return this._populate}},{key:"hasPopulate",value:function(){var e=this._populate;return Array.isArray(e)&&e.length>0}},{key:"reset",value:function(){_get(Object.getPrototypeOf(t.prototype),"reset",this).call(this),this._populate=[]}}]),t}(_vador.Request);exports.HalRequest=HalRequest;
},{"vador":37}],68:[function(require,module,exports){
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_get=function(e,r,t){for(var n=!0;n;){var o=e,i=r,a=t;u=l=s=void 0,n=!1;var u=Object.getOwnPropertyDescriptor(o,i);if(void 0!==u){if("value"in u)return u.value;var s=u.get;return void 0===s?void 0:s.call(a)}var l=Object.getPrototypeOf(o);if(null===l)return void 0;e=l,r=i,t=a,n=!0}},_vador=require("vador"),_normalizeUrl=require("normalize-url"),_normalizeUrl2=_interopRequireDefault(_normalizeUrl),_lodashAssign=require("lodash.assign"),_lodashAssign2=_interopRequireDefault(_lodashAssign),_halRequest=require("./halRequest"),_interceptors=require("./interceptors/"),_bluebird=require("bluebird"),_bluebird2=_interopRequireDefault(_bluebird),REGEX_LASTPART=/\/([^\/]*)\/?$/,HalResource=function(e){function r(e,t){var n=void 0===arguments[2]?{}:arguments[2];_classCallCheck(this,r),_get(Object.getPrototypeOf(r.prototype),"constructor",this).call(this,e,t,n),this._request=new _halRequest.HalRequest(t,this),this._relations=this._config.relations||null,this._restKeys.push("**links**","**selfLink**","**hasLinks**");var o=[new _interceptors.EmbeddedExtractorInterceptor,new _interceptors.LinkExtractorInterceptor,new _interceptors.IdExtractorInterceptor,new _interceptors.PopulateInterceptor];this._interceptors=o.concat(this._interceptors)}return _inherits(r,e),_createClass(r,[{key:"_createSubInstance",value:function(e,t){return new r(e,t,this._allConfig)}},{key:"_transformToLink",value:function(e,r,t){var n=this,o=null,i=r.href,a=r.type;if(null===e)return{type:a,newValue:o};if("many"===a){if(!Array.isArray(e))throw new Error("For relation "+t+", the value must be an Array");o=[],e.forEach(function(e){var r=n._transformToLinkOne(e,i,t);null!==r&&o.push(r)})}else o=this._transformToLinkOne(e,i,t);return{type:a,newValue:o}}},{key:"_transformToLinkOne",value:function(e,r,t){if(null==e)return null;if(e.id)return(""+r+"/"+e.id).replace(/\/{2,}/,"/");throw new Error("For relation "+t+", the value must have id")}},{key:"save",value:function(e){var t=this,n=_lodashAssign2["default"]({},this._relations||{});return n&&Object.keys(n).forEach(function(r){if(e.hasOwnProperty(r)){var o=t._transformToLink(e[r],n[r],r),i=(o.type,o.newValue);e[r]=i}}),_get(Object.getPrototypeOf(r.prototype),"save",this).call(this,e)}},{key:"_proxifyOne",value:function(e,t){var n=this,o=_get(Object.getPrototypeOf(r.prototype),"_proxifyOne",this).call(this,e),i=e["**links**"];return i&&Object.keys(i).forEach(function(e){if(!o.hasOwnProperty(e)){var r=i[e],t=r.substring(0,r.indexOf(e)),a=n._createSubInstance(t,e);!function(r){var t=void 0;Object.defineProperty(o,""+e+"Async",{enumerable:!1,get:function(){return void 0!==t?_bluebird2["default"].resolve(t):r.findAll().sendRequest().spread(function(e){return t=e,_bluebird2["default"].resolve(t)})}})}(a)}}),o}},{key:"populate",value:function(){for(var e,r=arguments.length,t=Array(r),n=0;r>n;n++)t[n]=arguments[n];return(e=this._request).populate.apply(e,t),this}}]),r}(_vador.RestResource);exports.HalResource=HalResource;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _toConsumableArray(e){if(Array.isArray(e)){for(var r=0,t=Array(e.length);r<e.length;r++)t[r]=e[r];return t}return Array.from(e)}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var o=r[t];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}return function(r,t,o){return t&&e(r.prototype,t),o&&e(r,o),r}}(),_get=function(e,r,t){for(var o=!0;o;){var a=e,n=r,u=t;i=s=d=void 0,o=!1;var i=Object.getOwnPropertyDescriptor(a,n);if(void 0!==i){if("value"in i)return i.value;var d=i.get;return void 0===d?void 0:d.call(u)}var s=Object.getPrototypeOf(a);if(null===s)return void 0;e=s,r=n,t=u,o=!0}},_vador=require("vador"),_lodashHas=require("lodash.has"),_lodashHas2=_interopRequireDefault(_lodashHas),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),debug=new _debug2["default"]("halClient [Interceptor]"),EMBEDDED="_embedded",EmbeddedExtractorInterceptor=function(e){function r(e){_classCallCheck(this,r),_get(Object.getPrototypeOf(r.prototype),"constructor",this).call(this),this.tagEmbedded=e||EMBEDDED}return _inherits(r,e),_createClass(r,[{key:"response",value:function(e){debug("embedded extractor start");var r=e.value,t=e.request;if(t.responseType===Array&&_lodashHas2["default"](r,""+this.tagEmbedded+"."+t.resourceName)){var o=[];for(var a in r)a!==this.tagEmbedded&&(o[a]=r[a]);o.push.apply(o,_toConsumableArray(r[this.tagEmbedded][t.resourceName])),r=o}return e.value=r,debug("embedded extractor end"),e}},{key:"responseError",value:function(e){console.error("embedded extractor responseError",e)}}]),r}(_vador.ResponseInterceptor);exports.EmbeddedExtractorInterceptor=EmbeddedExtractorInterceptor;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{"default":e}}function _classCallCheck(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}function _inherits(e,r){if("function"!=typeof r&&null!==r)throw new TypeError("Super expression must either be null or a function, not "+typeof r);e.prototype=Object.create(r&&r.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),r&&(e.__proto__=r)}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,r){for(var t=0;t<r.length;t++){var n=r[t];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(e,n.key,n)}}return function(r,t,n){return t&&e(r.prototype,t),n&&e(r,n),r}}(),_vador=require("vador"),_lodashHas=require("lodash.has"),_lodashHas2=_interopRequireDefault(_lodashHas),_bluebird=require("bluebird"),_bluebird2=_interopRequireDefault(_bluebird),_debug=require("debug"),_debug2=_interopRequireDefault(_debug),debug=new _debug2["default"]("halClient [Interceptor]"),CACHE_FETCH="**cache_fetch**",PopulateInterceptor=function(e){function r(){_classCallCheck(this,r),null!=e&&e.apply(this,arguments)}return _inherits(r,e),_createClass(r,[{key:"response",value:function(e){var r=this;debug("populate interceptor begin");var t=e.value,n=e.request;if(!e.hasValue())return debug("id extractor end (do nothing)"),e;var u=[];return Array.isArray(t)?t.forEach(function(e){u.push(r._populateOne(e,n))}):u.push(this._populateOne(t,n)),_bluebird2["default"].all(u).then(function(){return debug("populate interceptor end"),e})}},{key:"_populateOne",value:function(e,r){debug("populate one");var t=e["**links**"];e[CACHE_FETCH]=[];var n=[];return r.populates.forEach(function(u){var o=u.split("."),a=o.shift();console.log(o,a);var l=t[a];if(a&&_lodashHas2["default"](t,a)&&!~e[CACHE_FETCH].indexOf(l)){e[CACHE_FETCH].push(l);var i=l.substring(0,l.indexOf(a)),s=r.restResource._createSubInstance(i,a),p=s.findAll();o&&o.length&&p.populate(o.join(".")),p=p.sendRequest().then(function(r){e[a]=r[0]}),n.push(p)}}),_bluebird2["default"].all(n).then(function(){_lodashHas2["default"](e,CACHE_FETCH)&&delete e[CACHE_FETCH]})}},{key:"responseError",value:function(e){console.error("populate extractor responseError",e)}}]),r}(_vador.ResponseInterceptor);exports.PopulateInterceptor=PopulateInterceptor;
