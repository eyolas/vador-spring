...
"use strict";function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0});var _createClass=function(){function e(e,t){for(var r=0;r<t.length;r++){var s=t[r];s.enumerable=s.enumerable||!1,s.configurable=!0,"value"in s&&(s.writable=!0),Object.defineProperty(e,s.key,s)}}return function(t,r,s){return r&&e(t.prototype,r),s&&e(t,s),t}}(),_request=require("./request"),_http=require("./http"),RestResource=function(){function e(t,r){var s=void 0===arguments[2]?{}:arguments[2];_classCallCheck(this,e),this._baseUrl=t+"/",this._resourceName=r,this._config=s,this._config.defaultHeaders=s.defaultHeaders||{},this._config.interceptors=s.interceptors||[],this._config.http=s.http||new _http.Http}return _createClass(e,[{key:"constructBaseRequest",value:function(){var e=void 0===arguments[0]?"get":arguments[0],t=void 0===arguments[1]?Array:arguments[1],r=void 0===arguments[2]?"":arguments[2],s=new _request.Request(this._baseUrl,this._resourceName,this,this._config);return s.responseType=t,s.url=this._baseUrl+this._resourceName+r,s.method=e,s}},{key:"config",set:function(e){this._config=e}},{key:"findAll",value:function(){return this.constructBaseRequest()}},{key:"findOne",value:function(e){return this.constructBaseRequest("get",Object,"/"+e)}},{key:"save",value:function(e){var t=void 0;return t=e.hasOwnProperty("id")?this.merge(e):this.create(e),t.sendRequest()}},{key:"create",value:function(e){return this.constructBaseRequest("post",Object).send(e)}},{key:"merge",value:function(e){return this.constructBaseRequest("put",Object,"/"+e.id).send(e)}},{key:"_createSubInstance",value:function(t,r,s){return new e(t,r,s)}}]),e}();exports.RestResource=RestResource;
